                    ...
                    <li class="dropdown user user-menu">
                        ...
                        <ul class="dropdown-menu">
                            ...
                            <li class="user-body" style="background-color:lightgrey">
                                ...
                                <div>
                                    <a href="adminProfileFormView" class="btn btn-default btn-flat" style="width:100%">Profile</a>
                                </div>
                                <br>
                                <div>
                                    <a href="deactivateAdminFormView" class="btn btn-default btn-flat" style="width:100%">Deactivate Account</a>
                                </div>
                                <br>
                                <div>
                                    <a href="changeAdminPasswordFormView" class="btn btn-default btn-flat" style="width:100%">Change Password</a>
                                </div>
                                <br>
                                <div>
