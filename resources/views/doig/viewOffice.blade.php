                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row" style="border-radius: 8px;background-color: lightgray">
                                ...
                                <div class="col-md-2 table-col tc-left" style="background-color: whitesmoke;margin-left:30px;margin-top: 30px">
                                    ...
                                    <div class="card">
                                        <div class="bg-grey">
                                            <button onclick="myFunction('evidencesList')" class="w3-button w3-block w3-theme-l1 w3-left-align"><i class="fa fa-calendar-check-o fa-fw w3-margin-right"></i>Ongoing Entries</button>
                                            <br>
                                        ...
                                        <div class="col-md-12">
                                            <div class="card">
                                                ...
                                                <div class="form-group">
                                                    <form method="post" action="{{ route('entryDOIGAction') }}" enctype="multipart/form-data">
                                                        @csrf
