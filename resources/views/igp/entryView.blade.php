                    ...
                    <div class="box-body">
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row" style="border-radius: 8px;background-color: lightgray">
                                                        ...
                                                        <form method="post" action="{{ route('entryOICAction') }}" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group row mb-0">
                                                                ...
                                                                @if($entry->status=="ongoing")
                                                                    ...
                                                                    <div class="col-md-2 offset-md-3 col-xs-6"  style="width: 18.75%">
                                                                        <input type="submit" class="btn btn-facebook" name="ongoingSubmit" value="Forward" >
                                                                    </div>
                                ...
                                <!-- Right Column -->
                                <div class="col-md-3" style="margin-bottom: 10px;margin-left:30px;border-radius: 8px;background-color: whitesmoke;margin-top: 30px">
                                    @if($entry->status=="ongoing")
                                    <div class="row">
                                        <button type="button" style="margin: 10px 10px 0px 10px;width=100%;align:fit-content" class="btn btn-danger" data-toggle="modal" data-target="#createPost">
                                                Create a Post
                                            </button>
                                    </div>
                                    @endif
                                    <div class="row" >
                                        <div class="card" style="margin-bottom: 10px;margin-left: 10px;margin-right: 10px;border-radius: 8px;background-color: whitesmoke;margin-top: 5px;">

                                                <div class="card" style="margin-top: 10px">
                                                    <div class="page-header" style="text-align: center">{{ __('Progress') }}</div>
                                                    <div class="card-body">
                                                        <div class="form-group row">
